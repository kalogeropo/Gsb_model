...
#here we write the results to excel in order for automation with perpose of further editing
        ...
        df = pd.DataFrame.from_dict({"set based":av_precision,"GSB"
                                                              "":av_precision_gsb,"Negative Maincore":av_precision_gsb_mc,
                                     "Percentage Split":av_precision_gsb_dens,"Dot Split":av_precision_gsb_coreRank,"Constant WIndow":av_precision_constant, "Sentence_Paragraph":av_precision_sen_par, "Gsb-set":setMdouk
                                     ,"neg-main-set":setMmain,"perc-set":setMdens,"dot-set":setMcr, "Constant_Window-set":setMcon, "Sentence_Paragraph-set":setMsp})
        writer = pd.ExcelWriter("new_res.xlsx" , engine="openpyxl" , mode="a")
        writer.book = load_workbook("new_res.xlsx" )
        try:
